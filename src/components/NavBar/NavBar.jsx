    ...
    return (
        <header>
            <div className='d-flex justify-content-between align-items-center py-4 container-xxl'>
                <Link to="/">
                    <img className='LogoNavBar' src={Logo} alt="Logo" width={200} />
                </Link>
                <ul className='d-flex'>
                    ...
                    <div className="dropdown">
                     ...
                     <ul className=" dropdown-menu">
                        <Link className='dropdown-item colortexto1 texto24 px-3' to="/Productos">Todos</Link>
                        <Link className='dropdown-item colortexto1 texto24 px-3' to="/Categoria/Piscos">Piscos</Link>
                        <Link className='dropdown-item colortexto1 texto24 px-3' to="/Categoria/Vinos">Vinos</Link>
                        <Link className='dropdown-item colortexto1 texto24 px-3' to="/Categoria/Macerados">Macerados</Link>
                     </ul>
                    </div>
